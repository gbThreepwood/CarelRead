...
This command is only executed if the previous command has retured some valid data. I suppose this means that the monitoring software has detected the presense of the controller.
...
```
06 02 33 52 4f 4f 03 32 38
..3ROO.28       
```

```
02 33 52 4f 36 34 39 43 30 30 30 30 39 43 36 34 36 34 39 43 03 34 3b
.3RO649C00009C64649C.4;
```

The response is the same for all controllers, i.e.: RO649C00009C64649C
...
====================================================
### Command Summary
The following variations are observed:

- \<Acknowledge\> \<Start of text\> \<Address\> \<Command\> \<End of text\> \<Checksum\>
- \<Start of text\> \<Address\> \<Command\> \<End of text\> \<Checksum\>
- \<Enquiry\> \<Address\>

#### Response
- \<Start of text\> \<Address\> \<18 bytes data\> \<End of text\> \<Checksum\>
- \<Start of text\> \<Address\> \<2 bytes data\> \<End of text\> \<Checksum\>
...
The following table summarizes all the captured commands:

| Command | Description |
| --- | --- |
| ? | Enquire controller version. |
| REI | Unknown |
| RIJ | Unknown |
| RJK | Unknown |
| RKL | Unknown |
...
| RNO | Unknown |
| ROO | Unknown |
| *blank* | Enquire controller temperature status |
